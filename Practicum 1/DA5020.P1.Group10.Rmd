...
Download csv file and load as addiction_df
...
Utilize mutate function to match values from admissions_data to the values from the smaller dataframes and replace them.
```{r}
